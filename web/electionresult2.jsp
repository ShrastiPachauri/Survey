...
<html>
    ...
    <body>
        ...
        "<div class='container'>"+
            "<div id='dv1' onclick='resultbycity()'><img src='image/result.jpg' height='255px' width='225px'><br><h3>Result of Citys</h3></div>"+
            "<div id='dv2' onclick='resultbyparty()'><img src='image/img_by_party.png' height='250px' width='225px' style='background-color:black;'><br><h3>Result of Party</h3></div>"+
