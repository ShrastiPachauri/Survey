...
//        user.setMobile(Long.parseLong(request.getParameter("mobile")));
 user.setMobile(12345);
       ...
       System.out.println("RegistrationController running");
        try
        {
        ...
        catch(SQLException ex)
        {
            ...
            System.out.println("Exception occured in RegistrationController");
        }
        finally
        {
            System.out.println("RegistrationController requestDispatched");
